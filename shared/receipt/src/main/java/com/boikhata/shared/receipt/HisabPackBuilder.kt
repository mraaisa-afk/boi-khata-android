...
object HisabPackBuilder {
    ...
    fun buildPackText(
        ...
        sb.append("স্থূল মুনাফা: ${formatAmount(pnl.grossProfit)}\n")
        ...
        sb.append("  খাতার বাকি (প্রাপ্য): ${formatAmount(bs.receivables)}\n")
        ...
        sb.append("ইক্যুইটি:\n")
        sb.append("  সঞ্চিত মুনাফা: ${formatAmount(bs.retainedEarnings)}\n")
