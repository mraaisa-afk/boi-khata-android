...
- [ ] **Part B payment-model redesign — D92 DRAFTED 2026-09-20; FULL IMPLEMENTATION AUTHORIZED BY OWNER 2026-09-24 (P12):** see the P12 section below/PHASE_PLAN; the multi-line payment model (নগদ / ব্যাংক / মোবাইল ব্যাংকিং with provider selector / বাকি; combinable lines in ONE sale; 3-way paid+paid+বাকি explicitly in scope) is now being built per the D92 specification + owner's 2026-09-24 restatement. **P12 implementation began BEFORE the P11 exit-gate formally closed — by explicit owner override, logged so this is never mistaken for a properly closed gate.** P11 exit-gate open items at override time: B-005/B-006 device re-test, normal-sale regression re-run, B-013/B-014 + C-round device checks, Roborazzi screenshot tests, Part A device sweep, D88–D92 DECISIONS.md paste confirmations (D88/D90 confirmed pasted 2026-09-19; D91/D92 drafts pending)
